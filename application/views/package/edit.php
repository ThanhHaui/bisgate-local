        ...
        <div class="container-fluid">
            ...
            <section class="content new-box-stl ft-seogeo">
                    ...
                    <div class="col-sm-4">
                        <div class="box box-default padding20">
                            <div class="form-group">
                                ...
                                <input type="text"  <?php if ($package['PackageTypeId']==1) echo 'readonly';?>  data-field="Tên gói mở rộng" class="form-control hmdrequired" name="PackageName" value="<?php echo $package['PackageName']?>" placeholder="Nhập tên gói mở rộng">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                                ...
                                foreach($listRoles1 as $role1) {
                                    ...
                                    if(!empty($listRolesLv2)){
                                        ...
                                        <div class="packageRole">
                                            <label>
                                                <input type="checkbox" class="checkbox" name="RoleMenuId" <?php echo $disabled; ?> value="<?php echo $role1['RoleMenuId'].'-'.$role1['RoleMenuChildId']; ?> " <?php if (in_array($role1['RoleMenuId'],$arrayRolePackageId)) echo 'checked'?>>
                                            ...
                                            foreach ($listRolesLv2 as $role2) {
                                                ...
                                                if(!empty($listRolesLv3)){
                                                    ...
                                                    <div class="packageRole" style="position: relative; left: 20px;">
                                                        <label>
                                                            <input type="checkbox" class="checkbox" <?php echo $disabled2; ?> name="RoleMenuId" value="<?php echo $role2['RoleMenuId'].'-'.$role2['RoleMenuChildId']; ?>" <?php if (in_array($role2['RoleMenuId'],$arrayRolePackageId)) echo 'checked'?>>
                                                        ...
                                                        ?>
                                                            <div class="packageRole" style="position: relative; left: 40px;">
                                                                <label>
                                                                    <input type="checkbox" class="checkbox" <?php echo $disabled3; ?> name="RoleMenuId" value="<?php echo $role3['RoleMenuId'].'-'.$role3['RoleMenuChildId']; ?>" <?php if (in_array($role3['RoleMenuId'],$arrayRolePackageId)) echo 'checked'?>>
                                    ...
                                    <?php } else { ?>
                                        <div class="packageRole">
                                            <label>
                                                <input type="checkbox" class="checkbox" <?php echo $disabled; ?> name="RoleMenuId" value="<?php echo $role1['RoleMenuId'].'-'.$role1['RoleMenuChildId'] ?>" <?php if (in_array($role1['RoleMenuId'],$arrayRolePackageId)) echo 'checked'?>>
                                                <?php echo $role1['RoleMenuName']; ?>
                                            </label>
                                        </div>
                                        <?php
                ...
                <ul class="list-inline pull-right">
                    <li><button class="btn btn-primary submit" type="button">Lưu</button></li>
                    <li><a href="<?php echo base_url('package'); ?>" class="btn btn-default">Đóng</a></li>
                    <input type="hidden" hidden="hidden"  value="<?php echo $package['PackageId']?>" id="packageId">
                </ul>
                <?php echo form_close(); ?>
            </section>
        </div>
