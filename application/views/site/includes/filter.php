        ...
        <div class="content-filter stl-page">
            <form action="<?php echo base_url('search.html'); ?>" method="get">
                <div class="row line-filter">
                    ...
                    <div class="col-md-2 col-lg-2">
                        <div class="style-select">
                            <select name="bathroom">
                                <option value="0">Min. Bathroom</option>
                                <?php foreach($roomNumbers as $i): ?>
                    ...
                    <div class="col-md-2 col-lg-2">
                        <input class="style-text" type="text" name="s" value="<?php echo isset($_GET['s']) ? $_GET['s'] : ''; ?>" placeholder="Name">
                    </div>
                    <div class="col-md-2 col-lg-2">
                        <input class="style-btn-submit" type="submit" value="Search">
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="container-fluid">
        <div class="content-filter stl-page">
            <div class="line-filter">
                <div class="pull-left">
                    <form action="<?php echo base_url('search.html'); ?>" method="get">
                        <input hidden="hidden" style="display: none;" type="text" name="s" value="">
                        <input class="style-btn-submit" type="submit" value="Search">
                    </form>
                </div>
                <div class="pull-right">
                    <input class="style-btn-submit btn-advanced-search" type="button" value="Advanced Search">
                </div>
