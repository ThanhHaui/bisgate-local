                ...
                <div class="row justify-content-between align-items-center inner-top-header padding-headder">
                    ...
                    <div class="langue">
                        <div class="langue-box js-language">
                            <img src="assets/front/img/common/en.png" alt="en"/>
                            <span>English</span>
                            <i class="fa fa-caret-down" aria-hidden="true"></i>
                        </div>
                        <div class="langue-drop">
                            <ul>
                                <li class="vn"><a href="<?php echo $propertyCategoryRedirect; ?>">Việt Nam</a></li>
                                <li class="en"><a href="<?php echo base_url(); ?>">English</a></li>
                            </ul>
                        </div>
                    </div>
