        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="property dis-flex justify-content-between">
                        <div class="price-lang">
                            ...
                            <strong class="price">
                                <?php if($property['PriceMonth'] > 0) echo priceFormat($property['PriceMonth']).'/tháng';
                                elseif($property['PriceDay'] > 0) echo priceFormat($property['PriceDay']).'/ngày';
                                else echo 'Liên hệ'; ?>
                            </strong>
                        </div>
                        <?php if($property['PriceWeekend'] > 0){ ?>
                            <div class="price-lang">
                                ...
                                <strong class="price"><?php echo priceFormat($property['PriceWeekend']); ?>/ngày lễ</strong>
                            </div>
                        <?php } ?>
                    ...
                    <div class="content-detail">
                        ...
                        <div class="infor-detail">
                            <div class="top-detail dis-flex justify-content-between">
                                <div class="text-left">Chuyên mục: <?php implode(', ', $categoryNames); ?></div>
                                <div class="text-right">Vị trí: Ha Noi</div>
                            </div>
                            <div class="top-detail dis-flex justify-content-between">
                                <div class="text-left">Trang thiết bị: <?php echo $property['Equipment']; ?></div>
                                <div class="text-right">Hoàn thành: <?php echo $property['Furnished']; ?></div>
                            </div>
                            <?php $i = 0;
                            ...
                            <div class="list-utilities-detail">
                                <div class="row">
                                    ...
                                    <div class="col-4 col-sm-4 col-md-2 item">
                                        ...
                                        <div class="text">Khu vực sống</div>
                            ...
                            <div class="block-service">
                                ...
                                <div id="post-<?php echo $property['PropertyId']; ?>" class="box-service news-detail">
                                    <h3 class="ttl-service">Mô tả</h3>
                                    <?php echo $property['PropertyDesc']; ?>
                                </div>
                                <div class="box-service">
                                    <h3 class="ttl-service">Bản đồ</h3>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box-inquiry" id="stick-ban">
                        <h2 class="ttl-quiry">Liên hệ ngay</h2>
                        <form action="<?php echo base_url('feedback/insert'); ?>" method="post" id="feedbackForm">
                            ...
                            <div class="box-quiry">
                                <input class="style-text hmdrequired" type="text" name="PhoneNumber" placeholder="Số điện thoại *" data-field="Số điện thoại">
                            </div>
                            <div class="box-quiry">
                            ...
                            <input class="style-btn-submit trans" id="btnAddFeedback" type="button" value="Gửi">
                        </form>
                    </div>
                </div>
            </div>
            <?php if(!empty($listProperties)){ ?>
                <section class="sec-other">
                    <h2 class="ttl-other">Các căn hộ khác</h2>
                </section>
