<div class="row">
	<div class="col-sm-7">
		<div class="input-group margin">
			<div class="input-group-btn">
			    ...
			    <ul class="dropdown-menu">
			        <li class="dropdown-submenu">
			            ...
			            <ul class="dropdown-menu">
			                <?php foreach($this->Mconstants->vehicleStatus as $k => $v) :?>
			                    <li>
			                    	<div><a class="btn-filter-data" tabindex="-1" href="javascript:void(0);" text-opertor="là" value-operator="=" field-select="vehicle_status_id" check-length="0" value-id="<?php echo $k; ?>"><?php echo $v; ?></a></div>
			                    </li>
			                <?php endforeach;?>
			            </ul>
			        </li>
			...
			<input type="text" hidden="hidden" value="<?php echo base_url('vehicle/searchByFilter'); ?>" id="btn-filter">
