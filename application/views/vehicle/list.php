<?php $this->load->view('includes/header'); ?>
        ...
        <div class="container-fluid">
            <section class="content-header no-pd-lr">
                ...
                <ul class="list-inline new-stl">
                    ...
                    <li><button class="btn btn-primary" id="showModalVehicle">Thêm</button></li>
                    <?php endif; ?>
                </ul>
            ...
            <section class="content upn ft-seogeo">
                <div class="">
                    <?php $this->load->view('vehicle/_search'); ?>
                </div>
                <div class="">
    ...
    <?php if($permissionAdd): ?>
    <?php $this->load->view('vehicle/_modal_vehicle'); ?>
    <?php endif; ?>
    <?php $this->load->view('includes/modal/config_table', array('config_filter' => 'vehicle/_config_filter.php')); ?>
