<?php $this->load->view('includes/header'); ?>
        ...
        <div class="container-fluid">
            <section class="content-header no-pd-lr">
                ...
                <ul class="list-inline new-stl">
                    <li><a href="<?php echo base_url('deadline/add'); ?>" class="btn btn-primary" >Tạo lệnh gia hạn phần mềm</a></li>
                </ul>

            </section>
            <section class="content upn ft-seogeo">
                <div class="">
                    <?php $this->load->view('deadline/_search'); ?>
                </div>
                <div class="">
    ...
    <?php $this->load->view('includes/modal/config_table', array('config_filter' => 'deadline/_config_filter.php')); ?>
