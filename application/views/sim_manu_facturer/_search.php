<div class="row">
	<div class="col-sm-7">
		<div class="input-group margin">
			<div class="input-group-btn">
			    ...
			    <ul class="dropdown-menu">
			        <li class="dropdown-submenu">
			            <a class="btn-filter-data"  aria-expanded="false" data-toggle="dropdown" tabindex="-1" href="javascript:void(0);" value-id="0"><span>Tình trạng hợp tác</span> <span class="caret"></span></a>
			            <ul class="dropdown-menu">
			                <?php foreach($this->Mconstants->status as $k => $v) :?>
			                    <li>
			                    	<div><a class="btn-filter-data" tabindex="-1" href="javascript:void(0);" text-opertor="là" value-operator="=" field-select="status_id" check-length="0" value-id="<?php echo $k; ?>"><?php echo $v; ?></a></div>
			                    </li>
			                <?php endforeach;?>
			            </ul>
			        </li>
			...
			<input type="text" hidden="hidden" value="<?php echo base_url('simmanufacturer/searchByFilter'); ?>" id="btn-filter">
	...
	<div class="col-sm-3">
		 <div class="input-group margin"> 
             <ul id="btn_add_filter" class="form-control ">
                <li class="position-relative btn_add_filter_click" value="0">Danh sách bộ lọc <i class="fa fa-caret-down" aria-hidden="true"></i>
                    <ul>
