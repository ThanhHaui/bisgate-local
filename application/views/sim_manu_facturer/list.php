<?php $this->load->view('includes/header'); ?>
        ...
        <div class="container-fluid">
            <section class="content-header no-pd-lr">
                ...
                <?php if($permissionAdd): ?>
                    <li><button class="btn btn-primary" id="showModalSimManuFacturer">Thêm</button></li>
                <?php endif; ?>
                </ul>
            ...
            <section class="content upn ft-seogeo">
                <div class="">
                    <?php $this->load->view('sim_manu_facturer/_search'); ?>
                </div>
                <div class="">
                    ...
                    <div class="box-body table-responsive no-padding divTable">
                         <table class="table new-style table-hover table-bordered" id="table-data">
                            ...
                            <tbody id="tbodySimManuFacturer"></tbody>
                        </table>
                    </div>
    ...
    <?php if($permissionAdd): ?>
    <?php $this->load->view('sim_manu_facturer/_modal_sim_manu_facturer'); ?>
    <?php endif; ?>
    
    <?php $this->load->view('includes/modal/config_table', array('config_filter' => 'sim_manu_facturer/_config_filter.php')); ?>
