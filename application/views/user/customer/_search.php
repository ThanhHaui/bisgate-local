<div class="row">
    <div class="col-sm-7">
        <div class="input-group margin">
            ...
            <input type="text" hidden="hidden" value="<?php echo base_url('customer/searchByFilter/' . $roleId); ?>"
                   id="btn-filter">
            <input type="text" class="form-control" id="itemSearchName" placeholder="Nhập thông tin tìm kiếm"/>
            <!-- <span class="input-group-btn">
			    <button id="btn-popup-filter" disabled type="button" data-toggle="modal" data-target="#save-filter"
