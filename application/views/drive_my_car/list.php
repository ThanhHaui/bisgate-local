<?php $this->load->view('includes/header'); ?>
        ...
        <div class="container-fluid">
            <section class="content-header no-pd-lr">
                ...
                <ul class="list-inline new-stl">
                    <li><button class="btn btn-primary" id="showModalDriveMyCar">Thêm</button></li>
                </ul>

            </section>
            <section class="content upn ft-seogeo">
                <div class="">
                    <?php $this->load->view('drive_my_car/_search'); ?>
                </div>
                <div class="">
                        ...
                        <div class="row">
                            <div class="col-sm-3 fix-width-200">
                                <select class="form-control" id="selectAction" style="display: none;">
                                    ...
                                    <option value="delete_item">Xóa lái xe của tôi</option>
                                </select>
                            </div>
                    ...
                    <div class="box-body table-responsive no-padding divTable">
                         <table class="table new-style table-hover table-bordered" id="table-data">
                            ...
                            <tbody id="tbodyDriveMyCar"></tbody>
                        </table>
                    </div>
    ...
    <?php $this->load->view('drive_my_car/_modal_drive_my_car'); ?>
    
    <?php $this->load->view('includes/modal/config_table', array('config_filter' => 'drive_my_car/_config_filter.php')); ?>
