<div class="row">
	<div class="col-sm-7">
		<div class="input-group margin">
			<div class="input-group-btn">
			    ...
			    <ul class="dropdown-menu">
			        <li class="dropdown-submenu">
			            <a class="btn-filter-data"  aria-expanded="false" data-toggle="dropdown" tabindex="-1" href="javascript:void(0);" value-id="0"><span>Loại bằng</span> <span class="caret"></span></a>
			            <ul class="dropdown-menu">
			                <?php foreach($this->Mconstants->licenceTypes as $k => $v) :?>
			                    <li>
			                    	<div><a class="btn-filter-data" tabindex="-1" href="javascript:void(0);" text-opertor="là" value-operator="=" field-select="licence_type_id" check-length="0" value-id="<?php echo $k; ?>"><?php echo $v; ?></a></div>
			                    </li>
			                <?php endforeach;?>
			            </ul>
			        </li>
			...
			<input type="text" hidden="hidden" value="<?php echo base_url('drivemycar/searchByFilter/'.$roleId); ?>" id="btn-filter">
