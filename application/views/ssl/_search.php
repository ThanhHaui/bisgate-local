<div class="row">
	<div class="col-sm-7">
		<div class="input-group margin">
			<div class="input-group-btn">
			    ...
			    <ul class="dropdown-menu">
			        <li class="dropdown-submenu">
			            ...
			            <ul class="dropdown-menu">
			                <?php foreach($this->Mconstants->sslStatus as $k => $v) :?>
			                    <li>
			...
			<input type="text" hidden="hidden" value="<?php echo base_url('ssl/searchByFilter'); ?>" id="btn-filter">
            <div class="position-relative">
                <input type="text" class="form-control" id="itemSearchName" placeholder="Nhập thông tin tìm kiếm" />
                <i class="fa fa-search css-itemSearchName"></i>
            </div>
