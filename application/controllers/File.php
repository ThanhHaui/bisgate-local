...
class File extends MY_Controller {
	...
	public function upload(){
	    ...
	    if(!empty($fileBase64) & $fileTypeId > 0){
            ...
            $dir = '';
            $fileExt = 'png';
	        //if($fileTypeId == 1) $dir = IMAGE_PATH;
            if($fileTypeId == 2) $dir = USER_PATH;
    ...
    public function uploadNormal(){
        ...
        if(isset($_FILES['File']) && !empty($_FILES['File'])){
            ...
            if ($file['error'] > 0) echo json_encode(array('code' => -1, 'message' => ERROR_COMMON_MESSAGE));
                ...
                $fileExt = $names[count($names) - 1];
                if(in_array($fileExt, array('jpeg', 'jpg', 'png', 'bmp', 'doc', 'docx', 'xls', 'xlsx', 'pdf'))) {
                ...
                else echo json_encode(array('code' => -1, 'message' => "Tệp tin không hợp lệ"));
            }
        }
        else echo json_encode(array('code' => -1, 'message' => ERROR_COMMON_MESSAGE));
    }
