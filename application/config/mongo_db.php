...
$config['mongo_db']['default']['no_auth'] = getenv('MONGO_DB_NO_AUTH');
$config['mongo_db']['default']['hostname'] = getenv('MONGO_DB_HOST_NAME');
$config['mongo_db']['default']['port'] = getenv('MONGO_DB_PORT');
$config['mongo_db']['default']['username'] = getenv('MONGO_DB_USER_NAME');;
$config['mongo_db']['default']['password'] = getenv('MONGO_DB_PASSWORD');;
$config['mongo_db']['default']['database'] = getenv('MONGO_DB_DATABASE');;
